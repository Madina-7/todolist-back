...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"],
        _components_todo_list_todo_list_component__WEBPACK_IMPORTED_MODULE_6__["TodoListComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"],
        _app_routing_module__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"]] }); })();
...
const _c0 = function (a0) { return { "crossed": a0 }; };
function TodoListComponent_div_6_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function TodoListComponent_div_6_Template_input_ngModelChange_2_listener($event) { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const todo_r1 = ctx.$implicit; return todo_r1.completed = $event; })("ngModelChange", function TodoListComponent_div_6_Template_input_ngModelChange_2_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const todo_r1 = ctx.$implicit; const ctx_r4 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r4.updateItem(todo_r1); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TodoListComponent_div_6_Template_button_click_6_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r3); const todo_r1 = ctx.$implicit; const ctx_r5 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r5.removeItem(todo_r1); });
...
class TodoListComponent {
    ...
    addItem() {
        if (this.new_item) {
            ...
            this.http.post('/api/task', newitem).subscribe(data => {
    ...
    updateItem(item) {
        this.http.put('/api/task', item).subscribe(data => {
            // retrieve updated list 
            this.http.get('/api/task').subscribe(data => {
                console.log(data);
                // send to html by replacing content of this.todos
    ...
    removeItem(todo) {
        ...
        let httpParams = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpParams"]().set('taskid', todo._id);
        let options = { params: httpParams };
        this.http.delete('/api/task', options).subscribe(data => {
            // retrieve updated list 
            this.http.get('/api/task').subscribe(data => {
                console.log(data);
                // send to html by replacing content of this.todos
...
TodoListComponent.ɵfac = function TodoListComponent_Factory(t) { return new (t || TodoListComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"])); };
TodoListComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TodoListComponent, selectors: [["todo-list"]], decls: 7, vars: 2, consts: [["type", "text", "placeholder", "write here what you want to accomplish", 1, "todo-input", 3, "ngModel", "ngModelChange"], [1, "add", 3, "click"], ["class", "todo-item", 4, "ngFor", "ngForOf"], [1, "todo-item"], [1, "todo-item-left"], ["type", "checkbox", 1, "checkbox", 3, "ngModel", "ngModelChange"], [3, "ngClass"], [1, "remove-item"], [1, "remove-button", 3, "click"]], template: function TodoListComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function TodoListComponent_Template_input_ngModelChange_3_listener($event) { return ctx.new_item = $event; });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](4, "button", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TodoListComponent_Template_button_click_4_listener() { return ctx.addItem(); });
...
module.exports = __webpack_require__(/*! C:\Users\Madina\Desktop\dev\to-do-list\src\main.ts */"./src/main.ts");
